...
<form action="$self" method="POST" enctype="multipart/form-data">
    ...
    <table>
        ...
        <tr>
            <td></td>
            <td></td>
            <td><input type="submit" name="submit" value="সংরক্ষণ করুন"> <input type="reset" name="reset" value="পুণরায় লিখুন"> </td>
...
EOT;
        ...
        echo "<tr>";
           ...
           echo "<td>".aim_num_to_bn($row['date_of_birth'])."</td>";
           echo "<td>".aim_num_to_bn($row['national_id'])."</td>";
           echo "<td>".aim_num_to_bn($row['cell_no'])."</td>";
           echo "<td>".$row['designation']. "</td>";
           echo "<td>".aim_num_to_bn($row['salary'])."</td>";
           $image=BASE.$row['image_link'];
           echo "<td><img src='".$image."' width='50' height='50'/></td>";
           echo "<td><a class='anchor' href='".BASE."/employee/?option=edit&id=$id'>".সম্পাদনা."</a></td>";
           echo "<td><a class='anchor' href='".BASE."/employee/?process=delete&id=$id'>".বাতিল."</a></td>";
       echo "</tr>";
             }
         echo "</table>";       
 ...
 <?php  
   ...
   { 
       ...
       || ($_FILES["file"]["type"] == "image/jpg")
            ...
            move_uploaded_file($_FILES["file"]["tmp_name"], $img_link);     
       $business_save=aim_num_to_en($_POST['business']);
       $join_date_save=aim_num_to_en($_POST['join_date']);
       ...
       $date_of_birth_save=aim_num_to_en($_POST['date_of_birth']);
       ...
       $sql=mysql_query("UPDATE employee_info SET business='$business_save',join_date='$join_date_save', name='$name_save', fhname='$fhname_save', mother_name='$mother_name_save',
               ...
               date_of_birth='$date_of_birth_save', cell_no='$cell_no_save', designation='$designation_save', salary='$salary_save', image_link='$image_save' WHERE id='$id'" );
       if(!$sql)
       die(mysql_error());
       //echo "Row Updated"; 
    ...
    else  echo "<a class='anchor' href='".BASE."/employee/?option=add'>নতুন কর্মচারী সংযুক্ত করুন</a>"; 
